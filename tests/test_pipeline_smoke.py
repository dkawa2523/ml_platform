...
def test_tabular_pipeline_smoke(tmp_path):
    ...
    assert summary["pipeline_mode"] == "single_model"
...
@pytest.mark.parametrize(
    ("mode", "ensemble"),
    [
        ("comparison_best_model", {"enabled": False, "method": "mean_topk", "top_k": 2}),
        ("mean_topk_ensemble", {"enabled": True, "method": "mean_topk", "top_k": 2}),
        ("weighted_ensemble", {"enabled": True, "method": "weighted", "top_k": 2}),
    ],
)
